...
namespace WebApplication3.Controllers
{
    public class FirmaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FirmaID,FirmaAd,FirmaTel,FirmaAdres")] Firma firma)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FirmaID,FirmaAd,FirmaTel,FirmaAdres")] Firma firma)
        {
            if (id != firma.FirmaID)
            {
                return NotFound();
