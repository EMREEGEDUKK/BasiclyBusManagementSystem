        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirmaTel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FirmaAdres = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GarajID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GarajAdres = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GarajKapasite = table.Column<int>(type: "int", nullable: false),
                    Firma_ID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Garaj", x => x.GarajID);
                    table.ForeignKey(
                        name: "FK_Garaj_Firma_Firma_ID",
                        column: x => x.Firma_ID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtobusKapasite = table.Column<int>(type: "int", nullable: false),
                    Firma_ID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YolcuTel = table.Column<int>(type: "int", nullable: false),
                    Otobus_ID = table.Column<int>(type: "int", nullable: false),
                    OtobusID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
